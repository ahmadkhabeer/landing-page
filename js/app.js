...
const navigationBar = document.querySelector('.navigationBar__menu')
const navigationList = document.getElementById('navigationBar__list');
...
// Start of Toggle the navigationBar According to User Scroll Activity
function togglenavigationBar() {
    let userScroll;
    //Default Settings for navigationBar while scrolling
    ...
    userScroll = setTimeout(function () {
        //The Settings Executed on navigationBar after Timeout finished
        header.style.cssText = 'opacity: 0; transition: ease 0.3s ;'
    }, 6000);
}
// End of Toggle the navigationBar According to User Scroll Activity


//Start of the Scroll Event to execute the functions of activeSection and togglenavigationBar 
window.addEventListener('scroll', (event) => {
    activeSection();
    togglenavigationBar();
})
//End of the Scroll Event to execute the functions of activeSection and togglenavigationBar 
